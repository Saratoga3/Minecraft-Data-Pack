...
#迫擊砲2
execute if score fire mortar_time matches 5 run function superb_warfare:mortar/firing_parameters/firing_parameters2

#迫擊砲3
execute if score fire mortar_time matches 7 run function superb_warfare:mortar/firing_parameters/firing_parameters3

#迫擊砲4
execute if score fire mortar_time matches 9 run function superb_warfare:mortar/firing_parameters/firing_parameters4

#迫擊砲5
execute if score fire mortar_time matches 11 run function superb_warfare:mortar/firing_parameters/firing_parameters5
