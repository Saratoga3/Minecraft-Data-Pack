...
#輸入射擊參數
    ...
    #開火模式
    execute if entity @e[tag=mortar_target,tag=!hostile_mob,type=!minecraft:area_effect_cloud] unless score firing mortar_parameter matches 1 run scoreboard players set firing mortar_parameter 1
