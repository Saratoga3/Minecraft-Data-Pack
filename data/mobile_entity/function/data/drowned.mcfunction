...
#名字
    ...
    #設定名字
    data modify entity @s CustomName set value '{"text":"椅子","color":"green"}'
...
#雙手
    ...
    #設定雙手裝備
    data modify entity @s HandItems set value [{id:"trident",count:1b},{}]
...
#特性
    ...
    #設定追蹤距離
    attribute @s generic.follow_range base set 100

    #設定呼叫增援機率
    execute if score time mobile_entity matches 13000..23000 run attribute @s zombie.spawn_reinforcements base set 0.25
